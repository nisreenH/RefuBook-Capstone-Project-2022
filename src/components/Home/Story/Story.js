    ...
    return(
        <div className="bg-prim px-20">
          ...
          <div className="md:flex items-center p-12 gap-14 text-left text-white">
            ...
            <div className=" flex w-full relative p-16 flex-col gap-10">  
              <span className="font-bold my-7 bg-amber-200 text-prim text-xs p-2 rounded-md border-solid absolute -top-10 left-10" >{label}</span>
              ...
              <div className="flex gap-x-8">
                ...
                <div className="text-left bg-blue-300">
          ...
          <div className="md:flex items-center p-12 gap-14 text-left text-white ">
            ...
            <div className="w-full relative p-16 space-y-8">
              <span className="font-bold my-7 bg-amber-200 text-prim text-xs p-2 rounded-md border-solid absolute top-0 left-10  " >{label}</span>
              <p className="w-70 text-2xl">How I learned turkish quickly and what are the best places to learn.</p>
