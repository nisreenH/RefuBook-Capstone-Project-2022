    ...
    <nav className="w-full bg-white px-28 mb-10">
      <div className="justify-between px-4 mx-auto lg:max-w-7xl md:items-center md:flex md:px-8">
        ...
        <div>
          ...
          >
            <ul className="text-lightgray flex flex-col p-4 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 md:bg-white">
              <li>
                <Link to="/#" className="text-prim " ariaCurrent="page">
                  Home
                </Link>
              </li>
              <li>
